...
export default function BunkerOperationDetail({
  params,
}: {
  params: { ops_id: string };
}) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const consigneeOne =
        consignees.find((c: any) => c.ConsigneeType === "ConsigneeOne") ||
        consignees[0] ||
        null;
      const consigneeTwo =
        consignees.find((c: any) => c.ConsigneeType === "ConsigneeTwo") ||
        consignees[1] ||
        null;
      const consigneeThree =
        consignees.find((c: any) => c.ConsigneeType === "ConsigneeThree") ||
        consignees[2] ||
        null;
      ...
      const payload = {
        ...
        ConsigneeThreeID: consigneeThree
          ? consigneeThree.ConsigneeID || null
          : null,
  ...
  const handleSaveDetails = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        principal: opsData.principal || null,
  ...
  const handleRemoveConsignee = (idx: number) => {
    const newConsignees = (opsData.consignees || []).filter(
  ...
  const handleUpdateTask = async (
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE_URL}/bunkerOps/${ops_id}/task/${taskId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      toast.success(
        status === "Completed" ? "Task marked as done" : "Remark saved",
      );
  ...
  const handleUpdateEta = async (etaId: string) => {
    const etaRow = (opsData.etas || []).find(
      (e: any) => e.ops_eta_id === etaId,
    );
    if (!etaRow) return;
    ...
    try {
      ...
      const payload = {
        ...
        updated_to_port:
          etaRow.updated_to_port === true || etaRow.updated_to_port === "Done",
        updated_to_consignee:
          etaRow.updated_to_consignee === true ||
          etaRow.updated_to_consignee === "Done",
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <header className="glass-effect border-b px-4 py-3 sm:px-6 sm:py-4 sticky top-0 z-50 w-full flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => router.push("/bunkering-operations")}
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-xl text-gradient truncate">
                {opsData.vessel_name || "Unknown Vessel"}
              </h1>
              <p className="text-xs text-muted-foreground">
                {opsData.agency_ref_no}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[1400px] mx-auto p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    className="uppercase"
                    value={opsData.vessel_name || ""}
                    onChange={(e) =>
                      handleChange("vessel_name", e.target.value.toUpperCase())
                    }
                    disabled={isReadOnly}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    className="uppercase"
                    value={opsData.imo_number || ""}
                    onChange={(e) =>
                      handleChange("imo_number", e.target.value.toUpperCase())
                    }
                    disabled={isReadOnly}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    className="uppercase"
                    value={opsData.voyage_no || ""}
                    onChange={(e) =>
                      handleChange("voyage_no", e.target.value.toUpperCase())
                    }
                    disabled={isReadOnly}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={opsData.port || ""}
                    onChange={(e) =>
                      handleChange("port", e.target.value.toUpperCase())
                    }
                    disabled={isReadOnly}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    className="uppercase"
                    value={opsData.principal || ""}
                    onChange={(e) =>
                      handleChange("principal", e.target.value.toUpperCase())
                    }
                    disabled={isReadOnly}
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                {(opsData.consignees || []).map((c: any, index: number) => (
                  <div
                    key={index}
                    className="space-y-3 p-4 border rounded-lg bg-gray-50/50 dark:bg-gray-800/30 shadow-sm relative group"
                  >
                    <Button
                      variant="ghost"
                      size="icon"
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={opsData.greekLankaPIC || ""}
                    onValueChange={(val) => handleChange("greekLankaPIC", val)}
                    disabled={isReadOnly}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={opsData.bordingOfficer || ""}
                    onValueChange={(val) => handleChange("bordingOfficer", val)}
                    disabled={isReadOnly}
                  >
                    <SelectTrigger className="w-full bg-white dark:bg-gray-950">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <div className="flex gap-2 w-full">
                    <DatePicker
                      value={getLocalDateStr(opsData.ETA)}
                      onChange={(d) =>
                        handleDateTimeChange(
                          "ETA",
                          d,
                          getLocalTimeStr(opsData.ETA) || "00:00",
                        )
                      }
                      disabled={isReadOnly}
                    />
                    <TimePicker
                      value={getLocalTimeStr(opsData.ETA)}
                      onChange={(t) =>
                        handleDateTimeChange(
                          "ETA",
                          getLocalDateStr(opsData.ETA) ||
                ...
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <div className="flex gap-2 w-full">
                    <DatePicker
                      value={getLocalDateStr(opsData.ETB)}
                      onChange={(d) =>
                        handleDateTimeChange(
                          "ETB",
                          d,
                          getLocalTimeStr(opsData.ETB) || "00:00",
                        )
                      }
                      disabled={isReadOnly}
                    />
                    <TimePicker
                      value={getLocalTimeStr(opsData.ETB)}
                      onChange={(t) =>
                        handleDateTimeChange(
                          "ETB",
                          getLocalDateStr(opsData.ETB) ||
                            new Date().toLocaleDateString("en-CA"),
                          t,
                        )
                      }
                ...
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <div className="flex gap-2 w-full">
                    <DatePicker
                      value={getLocalDateStr(opsData.ETD)}
                      onChange={(d) =>
                        handleDateTimeChange(
                          "ETD",
                          d,
                          getLocalTimeStr(opsData.ETD) || "00:00",
                        )
                      }
                      disabled={isReadOnly}
                    />
                    <TimePicker
                      value={getLocalTimeStr(opsData.ETD)}
                      onChange={(t) =>
                        handleDateTimeChange(
                          "ETD",
                          getLocalDateStr(opsData.ETD) ||
                            new Date().toLocaleDateString("en-CA"),
                          t,
                        )
                      }
                ...
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <Input
                    type="number"
                    className="h-[42px]"
                    value={opsData.Estimate_port_stay || ""}
                    onChange={(e) =>
                      handleChange("Estimate_port_stay", Number(e.target.value))
                    }
                    disabled={isReadOnly}
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <DatePicker
                      value={getLocalDateStr(opsData.ATA)}
                      onChange={(d) =>
                        handleDateTimeChange(
                          "ATA",
                          d,
                          getLocalTimeStr(opsData.ATA) || "00:00",
                        )
                      }
                      disabled={isReadOnly}
                    />
                    <TimePicker
                      value={getLocalTimeStr(opsData.ATA)}
                      onChange={(t) =>
                        handleDateTimeChange(
                          "ATA",
                          getLocalDateStr(opsData.ATA) ||
                            new Date().toLocaleDateString("en-CA"),
                          t,
                        )
                      }
                ...
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <DatePicker
                      value={getLocalDateStr(opsData.ATB)}
                      onChange={(d) =>
                        handleDateTimeChange(
                          "ATB",
                          d,
                          getLocalTimeStr(opsData.ATB) || "00:00",
                        )
                      }
                      disabled={isReadOnly}
                    />
                    <TimePicker
                      value={getLocalTimeStr(opsData.ATB)}
                      onChange={(t) =>
                        handleDateTimeChange(
                          "ATB",
                          getLocalDateStr(opsData.ATB) ||
                            new Date().toLocaleDateString("en-CA"),
                          t,
                        )
                      }
                ...
                <div className="space-y-2 flex flex-col justify-end">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <DatePicker
                      value={getLocalDateStr(opsData.ATD)}
                      onChange={(d) =>
                        handleDateTimeChange(
                          "ATD",
                          d,
                          getLocalTimeStr(opsData.ATD) || "00:00",
                        )
                      }
                      disabled={isReadOnly}
                    />
                    <TimePicker
                      value={getLocalTimeStr(opsData.ATD)}
                      onChange={(t) =>
                        handleDateTimeChange(
                          "ATD",
                          getLocalDateStr(opsData.ATD) ||
                            new Date().toLocaleDateString("en-CA"),
                          t,
                        )
                      }
            ...
            <table className="min-w-full text-sm">
              <thead className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-center font-semibold w-[140px]">
                    Actions
                  </th>
                </tr>
              </thead>
                ...
                {(opsData.tasks || [])
                  ...
                  .map((t: any) => {
                    ...
                    return (
                      ...
                      >
                        <td className="px-4 py-3 border-r text-muted-foreground font-medium">
                          {t.stageName}
                        </td>
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to complete this operation? This will
                finalize the record, set its status to "Completed", and make it
        ...
        <Dialog
          ...
          onOpenChange={(open) => setDoneDialog((d) => ({ ...d, open }))}
        >
          <DialogContent className="max-w-md">
            ...
            <div className="py-2 space-y-3">
              <p className="text-sm text-muted-foreground">
                You can optionally add a remark before marking this task as
                done.
              </p>
              <Textarea
                ...
                onChange={(e) =>
                  setDoneDialog((d) => ({ ...d, remark: e.target.value }))
                }
              />
            </div>
        ...
        >
          <DialogContent className="max-w-md">
            ...
            <div className="py-2 space-y-3">
              <p className="text-sm text-muted-foreground">
                Add or update the remark for this task.
              </p>
              <Textarea
                ...
                onChange={(e) =>
                  setEditDialog((d) => ({ ...d, remark: e.target.value }))
                }
              />
            </div>
            <DialogFooter className="gap-2">
              ...
              <Button
                onClick={() => {
                  ...
                  const existingTask = (opsData.tasks || []).find(
                    (t: any) => t.task?.ops_task_id === taskId,
                  );
              ...
              <tbody className="divide-y text-sm">
                {(opsData.etas || [])
                  ...
                  .map((eta: any) => (
                    <tr
                      key={eta.ops_eta_id}
                      className="bg-white dark:bg-gray-900 border-b transition-all hover:bg-gray-50 dark:hover:bg-gray-800/80 hover:shadow-sm"
                    >
                      ...
                      <td className="px-4 py-4 text-center border-r align-middle w-[160px]">
                        <div className="flex flex-col items-center gap-1.5">
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleEtaChange(
                                ...
                                "updated_to_port",
                                !(
                                  eta.updated_to_port === true ||
                                  eta.updated_to_port === "Done"
                                ),
                              )
                            }
                          ...
                          >
                            <span
                              className={`inline-block h-5 w-5 transform rounded-full bg-white transition-transform shadow-sm ${eta.updated_to_port === true || eta.updated_to_port === "Done" ? "translate-x-8" : "translate-x-1"}`}
                            />
                            <span
                              className={`absolute text-[9px] font-bold ${eta.updated_to_port === true || eta.updated_to_port === "Done" ? "left-1.5 text-white" : "right-1.5 text-gray-500 dark:text-gray-400"}`}
                            >
                              {eta.updated_to_port === true ||
                              eta.updated_to_port === "Done"
                                ? "DONE"
                      ...
                      <td className="px-4 py-4 text-center border-r align-middle">
                        <div className="flex flex-col gap-1 mx-auto max-w-[220px]">
                          <span className="text-[10px] font-semibold text-center text-muted-foreground uppercase tracking-wider mb-0.5">
                            Received At
                          </span>
                          <div className="flex flex-col gap-1.5 bg-slate-50 dark:bg-slate-800/50 p-2 rounded-md border border-slate-200 dark:border-slate-700 shadow-inner">
                            <DatePicker
                              className="w-full text-xs h-8 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 focus:ring-1"
                              value={getLocalDateStr(eta.ETAReceivedDateTime)}
                              onChange={(d) =>
                                handleEtaDateTimeChange(
                                  eta.ops_eta_id,
                                  d,
                                  getLocalTimeStr(eta.ETAReceivedDateTime) ||
                                    "00:00",
                                )
                              }
                              disabled={isReadOnly}
                            ...
                            <TimePicker
                              className="w-full text-xs h-8 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 focus:ring-1"
                              value={getLocalTimeStr(eta.ETAReceivedDateTime)}
                              onChange={(t) =>
                                handleEtaDateTimeChange(
                                  eta.ops_eta_id,
                                  getLocalDateStr(eta.ETAReceivedDateTime) ||
                                    new Date().toLocaleDateString("en-CA"),
                                  t,
                                )
                              }
                      ...
                      <td className="px-4 py-4 text-center border-r align-middle w-[160px]">
                        <div className="flex flex-col items-center gap-1.5">
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleEtaChange(
                                ...
                                "updated_to_consignee",
                                !(
                                  eta.updated_to_consignee === true ||
                                  eta.updated_to_consignee === "Done"
                                ),
                              )
                            }
                          ...
                          >
                            <span
                              className={`inline-block h-5 w-5 transform rounded-full bg-white transition-transform shadow-sm ${eta.updated_to_consignee === true || eta.updated_to_consignee === "Done" ? "translate-x-8" : "translate-x-1"}`}
                            />
                            <span
                              className={`absolute text-[9px] font-bold ${eta.updated_to_consignee === true || eta.updated_to_consignee === "Done" ? "left-1.5 text-white" : "right-1.5 text-gray-500 dark:text-gray-400"}`}
                            >
                              {eta.updated_to_consignee === true ||
                              eta.updated_to_consignee === "Done"
                                ? "DONE"
                      ...
                      <td className="px-5 py-4 text-center align-middle w-[100px]">
                        <div className="flex flex-col items-center gap-1.5">
                          <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider opacity-0 hidden md:block">
                            Save
                          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Operation general comments..."
              value={opsData.comments || ""}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              className="min-h-[100px] resize-none"
              placeholder="Feedback or improvement areas..."
              value={opsData.areas_for_improvement || ""}
              onChange={(e) =>
