...
export default function OKTBPreviewPage() {
  const router = useRouter();
  const params = useParams();
  const { ccd_id } = params as { ccd_id: string };
  ...
  useEffect(() => {
    async function fetchPdf() {
      ...
      const res = await fetch(`${API_URL}/documents/oktb/${ccd_id}/pdf`, {
